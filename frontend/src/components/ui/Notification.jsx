...
const Notification = ({ notification, onClear }) => {
  ...
  return (
    <div 
      className={`fixed bottom-5 right-5 z-50 flex items-center p-4 rounded-lg shadow-xl text-white transition-all duration-300 ${typeClasses[notification.type]} ${visible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}
    >
